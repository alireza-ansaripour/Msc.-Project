...
public class NetworkPacket implements Cloneable {
    ...
    public final void setArray(final byte[] array) {
        if (isSdnWise(array)) {
            if (array.length <= MAX_PACKET_LENGTH && array.length
                ...
                setMSGIndex(array[MSG_INDEX]);
                setCUR(array[CUR_INDEX], array[CUR_INDEX + 1]);
    ...
    public NetworkPacket setCUR(byte valueH, byte valueL) {
        data[CUR_INDEX] = valueH;
        data[CUR_INDEX + 1] = valueL;
        return this;
    }
    ...
    public final NodeAddress getCUR() {
        return new NodeAddress(data[CUR_INDEX], data[CUR_INDEX + 1]);
    }
    ...
    public final NetworkPacket setMSGIndex(final byte index){
        data[MSG_INDEX] = index;
        return this;
    }
